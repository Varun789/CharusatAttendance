...
public class admin_rejected_form_review extends AppCompatActivity {

    private TextView emailid,id,name,counsellor,academic_year,semester,start_date,end_date,start_time,end_time,participated_in,type_of_event,event_name,organization,topic_of_work,type_of_participation,info,financial_support,feedback;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_rejected_form_review);
        ...
        feedback=findViewById(R.id.txt_faculty_feedback);
        ...
        formsRef.child(form_key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                feedback.setText(formpojo.getFaculty_feedback());
