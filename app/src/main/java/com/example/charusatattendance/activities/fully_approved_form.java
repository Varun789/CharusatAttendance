...
import com.example.charusatattendance.adapters.student_fully_approved_adapter;
...
public class fully_approved_form extends AppCompatActivity {
    ...
    private student_fully_approved_adapter adapter;
    FirebaseAuth mAuth;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fully_approved_form);
        ...
        adapter=new student_fully_approved_adapter(getApplicationContext(),forms);
        ...
        studentformsRef.child(uid).orderByChild("form_status").equalTo("fapproved").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
