...
import com.example.charusatattendance.adapters.admin_approved_adapter;
...
public class admin_aprroved_forms extends AppCompatActivity {
    ...
    private admin_approved_adapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_aprroved_forms);
        ...
        adapter=new admin_approved_adapter(getApplicationContext(),forms);

        requested_recycler_view.setAdapter(adapter);


        formRef.orderByChild("form_status").equalTo("approved").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
