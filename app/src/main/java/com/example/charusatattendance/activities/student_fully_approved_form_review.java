...
public class student_fully_approved_form_review extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_fully_approved_form_review);
    ...
    {
        studentformsRef.child(user.getUid()).child(form_key).child("image_name").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        downloadFiles(student_fully_approved_form_review.this,imageName,DIRECTORY_DOWNLOADS,url);
