...
public class student_rejected_form_review extends AppCompatActivity {
    TextView feedback,email_id,id,name,counsellor,semester,academic_year,type_of_event,event_name,start_date,end_date,start_time,end_time,participated_in,organization,topic_of_work,type_of_participation,info,financial_support;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_rejected_form_review);
