...
import com.example.charusatattendance.activities.student_fully_approved_form_review;
...
public class student_fully_approved_adapter extends RecyclerView.Adapter<RequestedHolder> {
    Context c;
    ArrayList<form_pojo> request;


    public student_fully_approved_adapter(Context c, ArrayList<form_pojo>request)
    {
        this.c=c;
    ...
    public void onBindViewHolder(@NonNull RequestedHolder holder, final int position) {
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onItemClickListener(View view, int position) {
                Intent i =new Intent(c, student_fully_approved_form_review.class);
