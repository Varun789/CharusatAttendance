...
import com.example.charusatattendance.activities.student_approved_form_review;
...
public class StudentApprovedAdapter extends RecyclerView.Adapter<RequestedHolder> {
        Context c;
    ArrayList<form_pojo>request;


    public StudentApprovedAdapter(Context c, ArrayList<form_pojo> request)
    {
        this.c=c;
       ...
       //object of Requestedholder
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onItemClickListener(View view, int position) {
              Intent i =new Intent(c, student_approved_form_review.class);
