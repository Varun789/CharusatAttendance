...
import com.example.charusatattendance.activities.admin_side_submitted_form_review;
...
public class admin_submitted_adapter extends RecyclerView.Adapter<RequestedHolder> {
    Context c;
    ArrayList<form_pojo>request;


    public admin_submitted_adapter(Context c, ArrayList<form_pojo>request)
    {
        this.c=c;
       ...
       //object of Requestedholder
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onItemClickListener(View view, int position) {
              Intent i =new Intent(c, admin_side_submitted_form_review.class);
